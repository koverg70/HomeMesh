...
echo #define NODE_ID 1 > node_id.h
cd Debug

make all && c:\utils\Electronics\arduino-1.0\hardware\tools\avr\bin\avrdude -pm328p -carduino "-P\\.\COM4" -b115200 -Uflash:w:HomeMesh.hex:a && start C:\utils\teraterm-4.78\ttermpro.exe /C=4 /BAUD=115200
